...
reg   [19:0] empty_fu_48;
wire   [19:0] select_ln509_1_fu_127_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (icmp_ln488_fu_87_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_sig_allocacmp_p_load = 20'd524288;
    end else begin
...
always @ (*) begin
    if (((icmp_ln488_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (icmp_ln488_fu_87_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        in0_V_TREADY = 1'b1;
    end else begin
        in0_V_TREADY = 1'b0;
    end
...
always @ (*) begin
    ap_condition_120 = (~((ap_start_int == 1'b0) | ((icmp_ln488_fu_87_p2 == 1'd0) & (in0_V_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end
...
assign icmp_ln488_fu_87_p2 = ((ap_sig_allocacmp_block_1 == 4'd10) ? 1'b1 : 1'b0);

assign idx_fu_93_p2 = (ap_sig_allocacmp_block_1 + 4'd1);

assign inval_V_fu_105_p1 = in0_V_TDATA[19:0];
